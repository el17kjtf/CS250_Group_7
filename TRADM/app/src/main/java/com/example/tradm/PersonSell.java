...
public class PersonSell extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_person_sell);
        ...
        buttonAddOffer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PersonSell.this, NewOfferActivity.class);
        ...
        setUpRecyclerView();
        button_choose_buy = findViewById(R.id.buy);

        button_choose_buy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PersonSell.this, PersonBuy.class);
                startActivity(intent);
            }
        });
    }
    ...
    private void setUpRecyclerView(){
        Query query = offerRef.orderBy("title", Query.Direction.ASCENDING).whereEqualTo("0",
                "sellerID");
        ...
        adapter.setOnItemClickListener(new OfferAdapter.OnItemClickListener() {
            ...
            public void onItemClick(DocumentSnapshot documentSnapshot, int position) {
                ...
                Intent intent = new Intent(PersonSell.this, OfferDetail.class);
